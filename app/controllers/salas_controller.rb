class SalasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @sala.save
        format.html { redirect_to salas_url, notice: 'Sala criada com sucesso.' }
        format.json { render :index, status: :created, location: @sala }
      else
  ...
  private
    ...
    def sala_params
      params.require(:sala).permit(:nome, :predio, :cont_proj, :disp)
    end
end
